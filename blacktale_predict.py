...
class DataProcessor(object):
    ...
    def get_single_example(self, text):
        """Gets a collection of `InputExample`s for prediction from text input."""
...
class BlackTaleProcessor(DataProcessor):
    ...
    def get_single_example(self, text):
        ...
        return [InputExample(guid="30000", text_a=text, text_b=None, label="无关紧要")]
